                ...
                <Form layout="horizontal">
                    ...
                    <div className="row justify-content-start ms-5"> 
                        <Form.Item className="col-md-6 col-sm-12">
                            ...
                            <Input name="nomeFant" value={form.nomeFant} onChange={onChange} />
                        </Form.Item>
                        <Form.Item className="col-md-5 col-sm-12">
                        ...
                        <Form.Item className="col-md-2 col-sm-12">
                            ...
                            <Input name="numero_casa" value={form.numero_casa.toString()} onChange={onChange} />
                        </Form.Item>
                        <Form.Item className="col-md-5 col-sm-12">
                        ...
                        <Form.Item className="col-md-6 col-sm-12">
                            ...
                            <Input name="mensagem" value={form.mensagem} onChange={onChange} />
                        </Form.Item>
                        <Form.Item className="col-md-3 col-sm-12">
                            <label id="cadText" className="form-label me-2">Hora inicio</label>
                            <TimePicker value={dayjs(form.inicio_atendimento, 'HH:mm:ss')} format="HH:mm" name="inicio_atendimento" />
                        </Form.Item>
                        <Form.Item className="col-md-3 col-sm-12">
