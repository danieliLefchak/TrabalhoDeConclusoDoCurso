...
insert into entidades (bairro, cidade, cnpj, email, endereco, estado, fim_atendimento, inicio_atendimento, mensagem, nome_fant, numero_casa, telefone, user_id) values ('são francisco', 'pato branco', '94.759.117/0001-05', 'danieli.marialefchak@gmail.com', 'travessa são francisco', 'pr', '19:09:45', '11:09:45', 'venham ver os dogs', 'danieli', '25', '46991183138', 2);
